...
module.exports = {
    entry: path.resolve(__dirname, 'transpiled', 'index.js'), // Aqui vai o arquivo de inicialização da nossa aplicação React, basicamente o arquivo que está utilizando o ReactDOM.render.
    output: {
